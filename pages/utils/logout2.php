...
<body>
    <div class="container">
        <img src="assets/img/utils/logout.png" alt="Logout">
        <p>
            Automatically Redirecting you to the main page in <span id="countdown">10</span>.
        </p>
        <a href="/mcc_hotel/">Go Back to the main page</a>
    </div>
    <script>
        var timeleft = 10;
